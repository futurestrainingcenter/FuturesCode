...
for (pitcher in pitchers){
  ...
  plots_row <- ggarrange(movement_plot, release_plot, ncol = 1)
  ggsave(plots_row,file=paste0("Futures Reports Images/", pitcher," - trackmanPlots.png"), width=4.35,height=6,units="in", dpi = 185)
