...
API_BASE_URL = 'https://prd-use-api-extforcedecks.valdperformance.com'
...
def get_test_data(access_token, team_id):
    ...
    response = requests.get(f'{API_BASE_URL}/v2019q3/teams/{team_id}/tests?ModifiedFromUTC={timestampOfLastRequest}&Page={currentPage}', headers=headers)
    response.raise_for_status()
    return response.json()

def create_csv(data, filename='trials_data.csv'):
