...
body = """
    <html>
    <body>
        <p>Dear Futures Members,</p>
        <p>We are pleased to present your personalized training reports for December. Please find them attached at the bottom of this email.</p>
        <p>Note: Your attendance score might reflect variations due to the holiday schedule. If you have any questions or need further clarification, please don't hesitate to contact us.</p>
        <i>*This email was auto generated by Futures Data Department.</i></p>
    </body>
</html>
"""
